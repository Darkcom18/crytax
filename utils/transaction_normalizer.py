...
class TransactionNormalizer:
    ...
    def classify_transaction_type(transaction: Transaction) -> str:
        ...
        """
        if transaction.type in [TransactionType.BUY, TransactionType.SELL, TransactionType.SWAP]:
            return "transfer"
        elif transaction.type in [TransactionType.STAKING_REWARD, TransactionType.AIRDROP, TransactionType.FARMING]:
            return "other_income"
        else:
            return "transfer"  # Default
    
    @staticmethod
    def filter_taxable_transactions(transactions: List[Transaction]) -> List[Transaction]:
        """
